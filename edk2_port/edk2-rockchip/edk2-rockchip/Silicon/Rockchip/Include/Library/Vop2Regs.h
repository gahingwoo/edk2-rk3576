...
#define RK3588_VOP2_REG_BASE  0x27D00000 /* RK3576 VOP2 base */
...
#define RK3588_VOP_GRF_BASE              0x2601A000 /* RK3576 VO0 GRF */
...
#define RK3588_VO0_GRF_BASE  0x2601A000 /* RK3576 VO0 GRF */

#define RK3588_VO1_GRF_BASE   0x2601A000 /* RK3576 VO0 GRF */
...
/*
 * RK3576 VOP2 per-port interface control registers.
 *
 * RK3576 abandons RK3588's global RK3568_DSP_IF_EN/IF_CTRL + VOP_GRF/VO1_GRF
...
#define RK3576_DSP_IF_CFG_DONE_IMD_BIT 31
...
/*
 * RK3576 display subsystem addresses (from rk3576.dtsi)
 * VOP2: vop@27d00000, compatible = "rockchip,rk3576-vop"
 * HDMI: hdmi@27da0000, compatible = "rockchip,rk3576-dw-hdmi-qp"
 * HDPTX PHY: hdmiphy@2b000000, compatible = "rockchip,rk3576-hdptx-phy"
 *
 * GRF registers:
 *   vo0_grf:      0x2601A000 (display output control, HDMI sync polarity)
 *   hdptxphy_grf: 0x26032000 (HDPTX PHY configuration)
 *   sys_grf:      0x26010000 (system GRF, VOP uses this)
 */
#define RK3576_VOP2_REG_BASE  0x27D00000

/* VOP GRF — on RK3576 the "VOP GRF" role is played by sys_grf (ioc_grf) */
#define RK3576_VOP_GRF_BASE   0x26010000

/* VO0 GRF — HDMI output control and sync polarity (equivalent to RK3588 VO1 GRF) */
#define RK3576_VO0_GRF_BASE   0x2601A000

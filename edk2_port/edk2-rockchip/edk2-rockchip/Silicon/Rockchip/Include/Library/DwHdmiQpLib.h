...
// code keeps building. Register *offsets* still differ (handled in C with
// SOC_RK3576 guards), but pointing the bases at the right windows lets the
// shared code paths reach the right peripherals.
//

...
{
  //
  // ROCK4D / RK3576: This library is built against RK3588 CRU base
  // (0xFD7C0000) and SARADC base (0xFEC10000), neither of which exist on
  // RK3576. Touching them in SEC hangs the SoC. Skip the early clock
  // configuration entirely; SARADC is not used during SEC/PEI on this port.
  //
  return RETURN_SUCCESS;

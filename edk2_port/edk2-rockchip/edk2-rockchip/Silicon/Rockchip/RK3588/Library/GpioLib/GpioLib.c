...
//
// ROCK4D / RK3576 port: GPIO base addresses are different from RK3588.
// Original RK3588 layout:  GPIO0=0xFD8A0000, GPIO1..4=0xFEC20000+(n-1)*0x10000
// RK3576 layout (from mainline rk3576.dtsi):
//   GPIO0 = 0x27320000
//   GPIO1 = 0x2AE10000
//   GPIO2 = 0x2AE20000
//   GPIO3 = 0x2AE30000
//   GPIO4 = 0x2AE40000
// Register layout is identical (same Rockchip GPIO IP).
//
#define GPIO_BASE(n)  ((n) == 0 ? 0x27320000UL : (0x2AE10000UL + ((n) - 1) * 0x10000))
  ...
  )
{
  DEBUG ((
    DEBUG_VERBOSE,
    "GpioPinWrite Group:%d Pin:%d Value:%d\n",
    Group,
    Pin,
    Value
    ));

  ...
  )
{
  ...
  DEBUG ((
    DEBUG_INFO,
    "[DRIVER]enter %a rate %d Dp->SSC %d \n",
    __func__,
    Dp->LINKRATE,
    Dp->SSC
    ));
  ...
  )
{
  ...
  switch (Dp->LINKRATE) {
    ...
    case 2700:
      ...
      PhyUpdateBits (
        Hdptx,
        LANE_REG (LANE, 0x0c2c),
        LN_TX_JEQ_EVEN_CTRL_HBR,
        0x70
        );
      PhyUpdateBits (
        Hdptx,
        LANE_REG (LANE, 0x0c34),

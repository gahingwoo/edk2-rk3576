  ...
  )
{
  ...
  WRITE_REG (
    host->instance->EXT_AX,
    0xa5 << FSPI_EXT_AX_AX_SETUP_PAT_SHIFT |
  ...
  )
{
  ...
  WRITE_REG (
    host->instance->EXT_AX,
    0x77 << FSPI_EXT_AX_AX_SETUP_PAT_SHIFT |

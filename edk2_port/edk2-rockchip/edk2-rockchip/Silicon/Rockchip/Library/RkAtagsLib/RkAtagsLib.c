...
#define ATAGS_BASE  ((UINTN) FixedPcdGet64 (PcdRkAtagsBase))
  ...
  )
{
  ...
  //
  // RK3576 / firewalled platforms: ATAGS region is not accessible.
  // Return NULL without touching the address (would bus-fault).
  //
  if (ATAGS_BASE == 0) {
    return NULL;
  }

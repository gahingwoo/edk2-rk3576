...
!if $(RK3576_PCIE_ENABLE) == TRUE
  ...
  # Must match the RK3576_PCIE_ENABLE block in Silicon/Rockchip/RK3576/RK3576.fdf.
  # A module listed in the FDF but absent here is a hard build failure
  # ("NOT found in DSC file"), which is how this board came to never build.
  EmbeddedPkg/Drivers/NonCoherentIoMmuDxe/NonCoherentIoMmuDxe.inf
!endif

# Likewise, this board set RK3576_GMAC_ENABLE = TRUE — which makes the shared
# FDF pull in the two GMAC modules — without listing them here.

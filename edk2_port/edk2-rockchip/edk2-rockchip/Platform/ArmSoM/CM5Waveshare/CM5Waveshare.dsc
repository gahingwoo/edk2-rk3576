...
[Defines]
  ...
  RK_PLATFORM_FVMAIN_MODULES     = $(PLATFORM_DIRECTORY)/CM5Waveshare.Modules.fdf.inc
  FIRMWARE_VER                   = "0.1"
...
[PcdsFixedAtBuild.common]
  ...
  gRockchipTokenSpaceGuid.PcdPlatformName|"CM5-Waveshare-CM4B"
  gRockchipTokenSpaceGuid.PcdPlatformVendorName|"ArmSoM"
  gRockchipTokenSpaceGuid.PcdFamilyName|"CM5"
  gRockchipTokenSpaceGuid.PcdProductUrl|"https://www.waveshare.com/wiki/CM4-IO-BASE-B"
  gRockchipTokenSpaceGuid.PcdDeviceTreeName|"rk3576-armsom-cm5-waveshare-cm4b"
  ...
  # SD card (sdmmc @ 0x2A310000) — slot on Waveshare CM4-IO-BASE-B carrier board

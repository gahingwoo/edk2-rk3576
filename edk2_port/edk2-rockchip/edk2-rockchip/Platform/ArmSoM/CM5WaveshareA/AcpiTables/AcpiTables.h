 ...
 *  ArmSoM CM5 on Waveshare CM4-IO-BASE-A carrier board
 *
 *  Same RK3576 silicon as Radxa ROCK 4D and FriendlyElec NanoPi M5.
 *  Defines are platform-agnostic at the silicon level; only device presence
 *  in Dsdt.asl differs between boards.
 *

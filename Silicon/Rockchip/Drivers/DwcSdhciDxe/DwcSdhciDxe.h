...
#define SD_MMC_HC_NOR_INT_STS  (DWC_SDHCI_BASE + 0x30)
#define SD_MMC_HC_ERR_INT_STS  (DWC_SDHCI_BASE + 0x32)
#define SD_MMC_HC_NOR_INT_SIG  (DWC_SDHCI_BASE + 0x38)
#define SD_MMC_HC_ERR_INT_SIG  (DWC_SDHCI_BASE + 0x3A)
...
#define CLOCK_CTRL_INT_CLK_ENABLE  BIT0
#define CLOCK_CTRL_INT_CLK_STABLE  BIT1

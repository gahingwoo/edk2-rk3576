...
#define HDMI0TX_PHY_BASE  0x2B000000
#define HDMI1TX_PHY_BASE  0x2B010000

#define HDPTXPHY0_GRF_BASE  0x26032000
...
//
// RK3576 has a single HDMI controller. The shared "RK3588_*" base macros
// below are remapped to the RK3576 register windows so the existing driver
// code keeps building. The names are kept as a reminder that these are the
// shared Rockchip display register definitions, not RK3576-native ones.
//
//   RK3588 SYS_GRF (HPD/HDMI status)  -> RK3576 IOC_GRF @ 0x26040000
//   RK3588 VO1_GRF (HDMI mux/iomux)   -> RK3576 VO0_GRF @ 0x2601A000
//
#define RK3588_SYS_GRF_BASE  0x26040000
#define RK3588_VO1_GRF_BASE  0x2601A000

//
// RK3576 VO0_GRF / IOC_GRF register layout (from upstream Linux
// drivers/gpu/drm/rockchip/dw_hdmi_qp-rockchip.c).
//
#define RK3576_VO0_GRF_SOC_CON1   0x0004
#define RK3576_HDMI_FRL_MOD       BIT0
#define RK3576_HDMI_HDCP14_MEM_EN BIT15

#define RK3576_VO0_GRF_SOC_CON8   0x0020
#define RK3576_COLOR_DEPTH_MASK   (0xF << 8)
/*
 * Colour depth/format fields in VO0_GRF_SOC_CON8: bits[11:8] depth,
 * bits[7:4] format.
 *
 * These two were inverted here, on the strength of a devmem dump from a
 * running Linux session that showed 0x0600 and was read as "6 is the 8 bpc
 * code".  It was a 10 bpc session: the Rockchip glue sets plat_data.max_bpc
 * = 10, so Linux negotiates 10 bpc against any deep-colour sink, and 0x600 is
 * exactly what a 10 bpc link writes.  Both references agree on the encoding
 * (mainline dw_hdmi_qp-rockchip.c:44-45, vendor rockchip_dw_hdmi_qp.c): an
 * 8 bpc link writes zero into this field.
 */
...
#define RK3576_I2S_SEL_MASK       BIT0
#define RK3576_SPDIF_SEL_MASK     BIT1
#define RK3576_SCLIN_MASK         BIT4
#define RK3576_SDAIN_MASK         BIT5
#define RK3576_HDMI_GRANT_SEL     BIT6

#define RK3576_IOC_MISC_CON0      0xA400
#define RK3576_HDMI_HPD_INT_MSK   BIT2
